...
try {
  ...
  assert.equal(await page.locator("[data-capture-chart]").count(), 16, "Capture Calendar should expose sixteen linked charts");
  assert.equal(await page.locator("[data-targeting-chart]").count(), 3, "Capture Calendar should expose three D3 targeting views");
  ...
  assert.equal(await mobile.locator("[data-capture-chart]").count(), 16, "Mobile Capture Calendar should expose all linked charts");
  assert.equal(await mobile.locator("[data-targeting-chart]").count(), 3, "Mobile Capture Calendar should expose all D3 targeting views");
