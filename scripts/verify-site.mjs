...
try {
  ...
  assert.equal(await page.locator("[data-analysis-actions] button").count(), 3, "Budget views should expose copy and export actions");
  ...
  assert.equal(await page.locator("[data-analysis-actions] button").count(), 3, "Pursuits should expose copy and export actions");
  ...
  assert.equal(await page.locator("[data-analysis-actions] button").count(), 3, "Cockpit should expose copy and export actions");
  ...
  assert.ok(mobileFilterBox && mobileFilterBox.height <= 215, `Mobile filters should remain compact while preserving 44px targets, got ${mobileFilterBox?.height}px`);
  ...
  assert.ok(mobileSourceHeroBox && mobileSourceHeroBox.y < 320, `Mobile Data Sources hero should follow the stacked provenance header, got ${mobileSourceHeroBox?.y}px`);
