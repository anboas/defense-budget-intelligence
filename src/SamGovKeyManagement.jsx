...
export default function SamGovKeyManagement({ auth, embedded = false }) {
  ...
  return <section data-sam-gov-key-management>
    ...
    <p className="if-detail-card__summary">This vault is the workspace-owned SAM.gov credential source. The scheduled repository snapshot still reports its separately managed automation credential until that job is migrated to workspace storage.</p>
