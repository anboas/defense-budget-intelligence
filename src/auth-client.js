...
export const authApi = {
  ...
  updateCommercialEntitlements: (id, values) => request(`/control-plane/organizations/${encodeURIComponent(id)}/entitlements`, { method: "PUT", body: JSON.stringify(values) }),
  updateCommercialOnboarding: (id, stepKey, values) => request(`/control-plane/organizations/${encodeURIComponent(id)}/onboarding/${encodeURIComponent(stepKey)}`, { method: "PATCH", body: JSON.stringify(values) }),
  createCommercialServiceRequest: (id, values) => request(`/control-plane/organizations/${encodeURIComponent(id)}/requests`, { method: "POST", body: JSON.stringify(values) }),
  updateCommercialServiceRequest: (id, requestId, values) => request(`/control-plane/organizations/${encodeURIComponent(id)}/requests/${encodeURIComponent(requestId)}`, { method: "PATCH", body: JSON.stringify(values) }),
