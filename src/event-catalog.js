...
export const EVENT_CATALOG_SOURCE_REGISTRY = Object.freeze([
  { id: "sam", name: "SAM.gov industry engagement notices", url: "https://sam.gov/content/opportunities", adapter: "sam_feed", branch: "Joint", priority: 110, cadenceHours: 2, maxDetailPages: 0 },
  { id: "osbp", name: "DoW Office of Small Business Programs", url: "https://business.defense.gov/", adapter: "list_detail", branch: "Joint", priority: 105, cadenceHours: 12, maxDetailPages: 8 },
  { id: "dau", name: "Defense Acquisition University", url: "https://www.dau.edu/events", adapter: "list_detail", branch: "Joint", priority: 105, cadenceHours: 8, maxDetailPages: 10 },
  { id: "ausa", name: "AUSA", url: "https://www.ausa.org/events/", adapter: "list_detail", branch: "Army", priority: 100, cadenceHours: 8, maxDetailPages: 10 },
  { id: "afcea", name: "AFCEA", url: "https://www.afcea.org/events", adapter: "list_detail", branch: "Joint", priority: 100, cadenceHours: 8, maxDetailPages: 10 },
  { id: "afa", name: "Air & Space Forces Association", url: "https://www.afa.org/events/", adapter: "list_detail", branch: "Air Force / Space Force", priority: 100, cadenceHours: 8, maxDetailPages: 8 },
  { id: "navy-league", name: "Navy League", url: "https://www.navyleague.org/meetings-and-events/", adapter: "list_detail", branch: "Navy", priority: 100, cadenceHours: 12, maxDetailPages: 8 },
  { id: "diu", name: "Defense Innovation Unit", url: "https://www.diu.mil/", adapter: "list_detail", branch: "Joint", priority: 100, cadenceHours: 8, maxDetailPages: 8 },
  { id: "darpa", name: "DARPA", url: "https://www.darpa.mil/", adapter: "list_detail", branch: "Fourth Estate", priority: 100, cadenceHours: 8, maxDetailPages: 8 },
  { id: "afwerx", name: "AFWERX", url: "https://afwerx.com/", adapter: "list_detail", branch: "Air Force", priority: 100, cadenceHours: 8, maxDetailPages: 8 },
  { id: "spacewerx", name: "SpaceWERX", url: "https://spacewerx.us/", adapter: "list_detail", branch: "Space Force", priority: 100, cadenceHours: 8, maxDetailPages: 8 },
  { id: "army-xtech", name: "Army xTech", url: "https://xtech.army.mil/", adapter: "list_detail", branch: "Army", priority: 100, cadenceHours: 8, maxDetailPages: 8 },
  { id: "nsin", name: "National Security Innovation Network", url: "https://www.nsin.us/", adapter: "list_detail", branch: "Joint", priority: 100, cadenceHours: 8, maxDetailPages: 8 },
  { id: "navalx", name: "NavalX", url: "https://www.secnav.navy.mil/agility/Pages/events.aspx", adapter: "list_detail", branch: "Navy", priority: 100, cadenceHours: 12, maxDetailPages: 8 },
  { id: "cto-innovation", name: "DoW CTO Innovation", url: "https://www.ctoinnovation.mil/events/", adapter: "list_detail", branch: "Joint", priority: 98, cadenceHours: 12, maxDetailPages: 8 },
  { id: "army-osbp", name: "Army Office of Small Business Programs", url: "https://www.army.mil/osbp", adapter: "list_detail", branch: "Army", priority: 98, cadenceHours: 12, maxDetailPages: 8 },
  { id: "air-force-small-business", name: "Air Force Small Business", url: "https://www.airforcesmallbiz.af.mil/", adapter: "list_detail", branch: "Air Force", priority: 98, cadenceHours: 12, maxDetailPages: 8 },
  { id: "navy-small-business", name: "Navy Office of Small Business Programs", url: "https://www.secnav.navy.mil/smallbusiness/Pages/events.aspx", adapter: "list_detail", branch: "Navy", priority: 98, cadenceHours: 12, maxDetailPages: 8 },
  { id: "dla-small-business", name: "DLA Small Business Events", url: "https://www.dla.mil/Small-Business/Events/", adapter: "list_detail", branch: "Fourth Estate", priority: 98, cadenceHours: 12, maxDetailPages: 8 },
  { id: "same", name: "SAME", url: "https://www.same.org/events/", adapter: "list_detail", branch: "USACE", priority: 95, cadenceHours: 12, maxDetailPages: 8 },
  { id: "sof-week", name: "SOF Week", url: "https://www.sofweek.org/", adapter: "jsonld", branch: "Joint", priority: 95, cadenceHours: 12, maxDetailPages: 4 },
  { id: "ndia", name: "NDIA", url: "https://www.ndia.org/events", adapter: "list_detail", branch: "Joint", priority: 95, cadenceHours: 8, maxDetailPages: 10 },
  { id: "apex-accelerators", name: "APEX Accelerators", url: "https://www.apexaccelerators.us/", adapter: "list_detail", branch: "Joint", priority: 95, cadenceHours: 12, maxDetailPages: 10 },
  { id: "space-foundation", name: "Space Foundation", url: "https://www.spacesymposium.org/", adapter: "jsonld", branch: "Air Force / Space Force", priority: 92, cadenceHours: 12, maxDetailPages: 4 },
  { id: "auvsi", name: "AUVSI", url: "https://www.xponential.org/", adapter: "jsonld", branch: "Joint", priority: 92, cadenceHours: 12, maxDetailPages: 4 },
  { id: "iitsec", name: "I/ITSEC", url: "https://www.iitsec.org/", adapter: "jsonld", branch: "Joint", priority: 92, cadenceHours: 12, maxDetailPages: 4 },
  { id: "marine-military-expos", name: "Marine Military Expos", url: "https://marinemilitaryexpos.com/", adapter: "list_detail", branch: "Marine Corps", priority: 92, cadenceHours: 12, maxDetailPages: 6 },
  { id: "spacecom", name: "SpaceCom", url: "https://commercialspaceweek.com/spacecom", adapter: "jsonld", branch: "Air Force / Space Force", priority: 90, cadenceHours: 24, maxDetailPages: 4 },
  { id: "sea-air-space", name: "Sea-Air-Space", url: "https://www.seaairspace.org/", adapter: "jsonld", branch: "Navy", priority: 90, cadenceHours: 24, maxDetailPages: 4 },
  { id: "sna", name: "Surface Navy Association", url: "https://www.navysna.org/", adapter: "list_detail", branch: "Navy", priority: 90, cadenceHours: 24, maxDetailPages: 6 },
  { id: "aoc", name: "Association of Old Crows", url: "https://www.crows.org/events/", adapter: "list_detail", branch: "Joint", priority: 90, cadenceHours: 24, maxDetailPages: 8 },
  { id: "quad-a", name: "Army Aviation Association of America", url: "https://www.quad-a.org/events/", adapter: "list_detail", branch: "Army", priority: 90, cadenceHours: 24, maxDetailPages: 8 },
  { id: "nga-us", name: "National Guard Association of the United States", url: "https://www.ngaus.org/events", adapter: "list_detail", branch: "National Guard", priority: 88, cadenceHours: 24, maxDetailPages: 6 },
  { id: "smd-symposium", name: "Space and Missile Defense Symposium", url: "https://smdsymposium.org/", adapter: "jsonld", branch: "Army / Space Force", priority: 88, cadenceHours: 24, maxDetailPages: 4 },
  { id: "potomac-officers-club", name: "Potomac Officers Club", url: "https://www.potomacofficersclub.com/govcon-events/", adapter: "list_detail", branch: "Joint", priority: 85, cadenceHours: 24, maxDetailPages: 8 },
]);
