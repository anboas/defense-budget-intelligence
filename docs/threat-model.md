...
| --- | --- | --- |
| Credential stuffing | PBKDF2 proofs, generic login errors, identity/IP attempt limits, secure cookies | No phishing-resistant MFA yet |
...
3. **Self-registration abuse:** public registration remains an intentional onboarding feature and should receive edge challenge/rate controls if Internet exposure or abuse increases.
